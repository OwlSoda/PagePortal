...
## 2024-06-01 - AutoMirrored Icons
**Learning:** Certain Material icons (like `LibraryBooks`, `List`) are direction-sensitive and deprecated in `Icons.Filled`. Using them directly causes build warnings.
**Action:** Always import these icons from `androidx.compose.material.icons.automirrored.filled` and use `Icons.AutoMirrored.Filled.X` to ensure RTL support and clean builds.
