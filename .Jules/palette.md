...
## 2024-10-27 - Search Input Keyboard Flow Optimization
**Learning:** Search fields without explicit keyboard actions leave the software keyboard open, obscuring search results and requiring manual dismissal, which is a poor micro-UX.
